...
Before taking review actions, read `../../SKILL.md` completely and follow its
workflow, scripts, preflights, timing requirements, artifact layout, and
progressive-disclosure references. Keep `../../SKILL.md` as the source of truth;
do not duplicate operational instructions in this wrapper.
