...
\usepackage{xcolor}
\usepackage{graphicx}
\graphicspath{{docs/research-paper-review-10min-talk/}{./}}
...
\title[Auditable Paper Review]{Auditable AI-Assisted Paper Review}
\subtitle{The \texttt{research-paper-review} Codex skill}
...
\begin{frame}{The project turns one paper into an auditable review package}
  \begin{block}{One-sentence description}
    \texttt{research-paper-review} is a Codex skill that converts a paper into
    OCR-backed evidence, staged critique, timing and provenance logs, a final
    review, rendered HTML, and a local follow-up explainer.
  \end{block}
...
\begin{frame}{The system separates inputs, processing, and outputs}
  \centering
  \includegraphics[width=0.98\textwidth,height=0.86\textheight,keepaspectratio]{research-paper-review-system-diagram.pdf}
